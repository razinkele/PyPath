...
if TYPE_CHECKING:
    ...
    from pypath.core.ecotracer import EcotracerParams
    from pypath.core.fleet_dynamics import FleetEconParams
    ...
    if HAS_PYODBC or HAS_PYPYODBC:
        ...
        try:
            ...
            try:
                ...
                df = pd.DataFrame(
                    [tuple(row) for row in cursor.fetchall()], columns=cols
                )
                return df
            finally:
                conn.close()
