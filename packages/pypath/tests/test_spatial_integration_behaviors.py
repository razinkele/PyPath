...
@pytest.fixture
def base_scenario(spatial_scenario):
    """Delegate to the shared conftest spatial_scenario fixture.

    Returns (scenario, n_groups) for backward compatibility with tests
    in this file. The shared fixture builds the same 5-group model.
    """
    scenario, _params = spatial_scenario
    return scenario, scenario.params.NUM_GROUPS
