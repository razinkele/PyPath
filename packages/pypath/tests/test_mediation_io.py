...
class TestReadMediation:
    ...
    def test_reads_shapes(self):
        ...
        shape_df = pd.DataFrame([{
            "ShapeID": 1, "Title": "Positive", "nPoints": 9,
            "YY1": 0.5, "YY2": 0.6, "YY3": 0.7, "YY4": 0.8,
            "YY5": 1.0, "YY6": 1.2, "YY7": 1.3, "YY8": 1.4, "YY9": 1.5,
        }])
        group_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "PredID", "PreyID", "AppliedWeight"])
        fleet_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
        landing_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
        ...
        with patch("pypath.io.ewemdb.list_ewemdb_tables", return_value=list(table_map.keys())):
            with patch("pypath.io.ewemdb.read_ewemdb_table", side_effect=lambda path, tbl: table_map[tbl]):
    ...
    def test_reads_group_links(self):
        ...
        shape_df = pd.DataFrame([{
            "ShapeID": 1, "Title": "Test", "nPoints": 9,
            "YY1": 1.0, "YY2": 1.0, "YY3": 1.0, "YY4": 1.0,
            "YY5": 1.0, "YY6": 1.0, "YY7": 1.0, "YY8": 1.0, "YY9": 1.0,
        }])
        group_df = pd.DataFrame([{
            "ScenarioID": 1, "ShapeID": 1, "GroupID": 3,
            "PredID": 2, "PreyID": 1, "AppliedWeight": 0.8,
        }])
        fleet_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
        landing_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
    ...
    def test_missing_tables_returns_empty(self):
        ...
        with patch("pypath.io.ewemdb.list_ewemdb_tables", return_value=["SomeOtherTable"]):
            with patch("pypath.io.ewemdb.read_ewemdb_table", side_effect=Exception("Table not found")):
                coll = read_mediation("fake.eweaccdb")
    ...
    def test_reads_fleet_links(self):
        ...
        shape_df = pd.DataFrame([{
            "ShapeID": 2, "Title": "FleetShape", "nPoints": 9,
            "YY1": 1.0, "YY2": 1.0, "YY3": 1.0, "YY4": 1.0,
            "YY5": 1.0, "YY6": 1.0, "YY7": 1.0, "YY8": 1.0, "YY9": 1.0,
        }])
        group_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "PredID", "PreyID", "AppliedWeight"])
        fleet_df = pd.DataFrame([{
            "ScenarioID": 1, "ShapeID": 2, "GroupID": 4,
            "FleetID": 2, "AppliedWeight": 0.5,
        }])
        landing_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
    ...
    def test_shape_with_fewer_than_9_points(self):
        ...
        shape_df = pd.DataFrame([{
            "ShapeID": 1, "Title": "Short", "nPoints": 5,
            "YY1": 0.8, "YY2": 0.9, "YY3": 1.0, "YY4": 1.1, "YY5": 1.2,
            "YY6": 1.0, "YY7": 1.0, "YY8": 1.0, "YY9": 1.0,
        }])
        group_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "PredID", "PreyID", "AppliedWeight"])
        fleet_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
        landing_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
    ...
    def test_link_referencing_unknown_shape_skipped(self):
        ...
        shape_df = pd.DataFrame([{
            "ShapeID": 1, "Title": "Known", "nPoints": 9,
            "YY1": 1.0, "YY2": 1.0, "YY3": 1.0, "YY4": 1.0,
            "YY5": 1.0, "YY6": 1.0, "YY7": 1.0, "YY8": 1.0, "YY9": 1.0,
        }])
        group_df = pd.DataFrame([{
            # ShapeID 99 does not exist in shapes
            "ScenarioID": 1, "ShapeID": 99, "GroupID": 1,
            "PredID": 2, "PreyID": 1, "AppliedWeight": 1.0,
        }])
        fleet_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
        landing_df = pd.DataFrame(columns=["ScenarioID", "ShapeID", "GroupID", "FleetID", "AppliedWeight"])
    ...
    def test_list_tables_exception_returns_empty(self):
        ...
        with patch("pypath.io.ewemdb.list_ewemdb_tables", side_effect=Exception("DB not found")):
