...
class TestCompleteWorkflow:
    ...
    def test_external_flux_from_connectivity_matrix(self):
        ...
        flux = calculate_spatial_flux(
            state.Biomass, ecospace, {}, t=0.25  # Quarter year
        )
    ...
    def test_hybrid_flux_larvae_adults(self):
        ...
        # Calculate flux
        flux = calculate_spatial_flux(state.Biomass, ecospace, {}, t=0.5)  # Mid-year
...
class TestEdgeCases:
    ...
    def test_isolated_patch(self):
        ...
        state = SpatialState(
            Biomass=np.array(
                [[0, 0, 0], [10, 20, 10]]  # High biomass in isolated patch
            )
        )
